...
int main(void)
{
    ...
    /*------------------------------------------------------------------------------------------------------------------
       ...
       Note 1 : The measured AVDD has deviation that causes by the band-gap voltage has deviation in different temperature, power voltage and ADC conversion deviation.(4 LSB)
                ...
                The Spec. of band-gap voltage in NUC029xEE series is as follows:
                -----------------------------------------------------------------------------------------
                |                  | Min.   | Typ.   | Max.   |                                         |
                |                  |--------------------------- VDD = 2.5 V ~ 5.5 V                     |
       ...
       Note 2: In this sample code is using the typical value of NUC029xEE series: 1.25 V, and it can be modified by VBG_VOLTAGE definition.
