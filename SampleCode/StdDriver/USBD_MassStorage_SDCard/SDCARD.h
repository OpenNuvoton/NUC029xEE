 ...
 * @file     sdcard.h
 * @version  V1.00
 * @brief    NUC029xEE series SD Card driver header file
 *
 * @note
...
/** @addtogroup NUC029xEE_Library NUC029xEE Library
  @{
*/

/** @addtogroup NUC029xEE_SDCARD SDCARD Library
  @{
*/

/** @addtogroup NUC029xEE_SDCARD_EXPORTED_CONSTANTS SDCARD Library Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC029xEE_SDCARD_EXPORTED_CONSTANTS */

/** @addtogroup NUC029xEE_SDCARD_EXPORTED_STRUCTS SDCARD Library Exported Structs
  @{
*/
...
/*@}*/ /* end of group NUC029xEE_SDCARD_EXPORTED_STRUCTS */

/** @addtogroup NUC029xEE_SDCARD_EXPORTED_FUNCTIONS SDCARD Library Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC029xEE_SDCARD_EXPORTED_FUNCTIONS */


/*@}*/ /* end of group NUC029xEE_SDCARD */

/*@}*/ /* end of group NUC029xEE_Library */
